...
namespace HobbyTracker.Controllers
{
    public class CommentController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "CommentID,CommunityID,TextInput")] Comment comment)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "CommentID,CommunityID,TextInput")] Comment comment)
        {
            if (ModelState.IsValid)
            {
